...
CONFIG = {
    ...
    "base_dir": BASE_DIR,
    "results_file": f"{BASE_DIR}/experiment_3/results/experiment_3_results.json",
    "padding_strategy": "repeat_last",
    "frame_cache_dir": f"{BASE_DIR}/experiment_3/frame_cache",
    "metadata_cache_file": f"{BASE_DIR}/experiment_3/processed_data_cache.pkl",
    "checkpoint_dir": f"{BASE_DIR}/experiment_3/checkpoints",
    "log_dir": f"{BASE_DIR}/experiment_3/logs",
    "model_dir": f"{BASE_DIR}/experiment_3/models",
    "force_recache": False,
...
print("🚀 EXPERIMENT 3: CROSS-MODAL PREDICTION")
print("="*70)
...
print(f"📁 Output Directory: {CONFIG['base_dir']}/experiment_3/")
print("="*70)
