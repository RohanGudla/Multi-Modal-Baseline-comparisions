...
CONFIG = {
    ...
    "base_dir": BASE_DIR,
    "results_file": f"{BASE_DIR}/experiment_2/results/experiment_2_results.json",
    "padding_strategy": "repeat_last",
    "frame_cache_dir": f"{BASE_DIR}/experiment_2/frame_cache",
    "metadata_cache_file": f"{BASE_DIR}/experiment_2/processed_data_cache.pkl",
    "checkpoint_file": f"{BASE_DIR}/experiment_2/checkpoints/multi_label_checkpoint.pth",
    "log_dir": f"{BASE_DIR}/experiment_2/logs",
    "model_dir": f"{BASE_DIR}/experiment_2/models",
    "force_recache": False,
...
print("🚀 EXPERIMENT 2: MULTI-LABEL CLASSIFICATION")
print("="*70)
...
print(f"📁 Output Directory: {CONFIG['base_dir']}/experiment_2/")
print("="*70)
