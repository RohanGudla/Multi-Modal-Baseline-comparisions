...
CONFIG = {
    ...
    "base_dir": BASE_DIR,
    "results_file": f"{BASE_DIR}/experiment_4_1fps/results/experiment_4_1fps_results.json",
    "padding_strategy": "repeat_last",
    "frame_cache_dir": f"{BASE_DIR}/experiment_4_1fps/frame_cache",
    "metadata_cache_file": f"{BASE_DIR}/experiment_4_1fps/processed_data_cache.pkl",
    "checkpoint_file": f"{BASE_DIR}/experiment_4_1fps/checkpoints/multi_modal_checkpoint.pth",
    "log_dir": f"{BASE_DIR}/experiment_4_1fps/logs",
    "model_dir": f"{BASE_DIR}/experiment_4_1fps/models",
    "force_recache": False,
...
print("🚀 EXPERIMENT 4: COMPLETE DOMAIN MAPPING (EMOTIONS↔BEHAVIORS) (1 FPS)")
print("="*70)
...
print(f"📁 Output Directory: {CONFIG['base_dir']}/experiment_4_1fps/")
print("="*70)
