...
CONFIG = {
    ...
    "base_dir": BASE_DIR,
    "results_file": f"{BASE_DIR}/experiment_1_1fps/results/experiment_1_1fps_results.json",
    "padding_strategy": "repeat_last",
    "frame_cache_dir": f"{BASE_DIR}/experiment_1_1fps/frame_cache",
    "metadata_cache_file": f"{BASE_DIR}/experiment_1_1fps/processed_data_cache.pkl",
    "checkpoint_dir": f"{BASE_DIR}/experiment_1_1fps/checkpoints",
    "log_dir": f"{BASE_DIR}/experiment_1_1fps/logs",
    "model_dir": f"{BASE_DIR}/experiment_1_1fps/models",
    "force_recache": False,
    "early_stopping_patience": 5,
    # New preprocessing options
    "use_optimized_preprocessing": True,  # Use optimized preprocessing for 1 FPS
    "preprocessed_data_dir": f"{BASE_DIR}/preprocessed_data_1fps",
    "force_reprocess": True  # Force reprocessing of videos+annotations at 1 FPS
}

print("🚀 EXPERIMENT 1: INDIVIDUAL MARKER TRAINING (1 FPS)")
print("="*70)
...
print(f"📁 Output Directory: {CONFIG['base_dir']}/experiment_1_1fps/")
print("="*70)
